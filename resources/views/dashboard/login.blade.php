...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('dashboard/AdminLte/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
    <div class="login-logo">
        <a href="javascript:(0);"><b>E3lan Misr Admin </b> <br> Login</a>
    </div>
    <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{asset('dashboard/AdminLte/plugins/iCheck/icheck.min.js')}}"></script>
<script>
    $(function () {
        $('input').iCheck({
