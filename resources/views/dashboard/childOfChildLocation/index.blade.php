                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @if($locations)
                            @foreach($locations as $location)
                                <tr>
                                    <td>{{$location->id}}</td>
                                    <td>{{$location->childOfChildLocation_en->location}}</td>
                                    <td>{{$location->childLocation->childLocation_en->location}}</td>
                                    <td>{{$location->created_at ? $location->created_at->diffForHumans() : ''}}</td>
                                    <td>{{$location->updated_at ? $location->updated_at->diffForHumans() : ''}}</td>
                                    <td>
                                        <a href="{{route('child-of-child-location.edit', $location->id)}}" class style="font-size: 20px"><i class="fa fa-pencil-square-o"></i> </a>
