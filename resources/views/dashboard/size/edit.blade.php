...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Billboard Sizes
            <small>Update Billboard Size</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{adminUrl('/')}}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{adminUrl('/parent-location')}}">Billboard Sizes</a></li>
            <li class="active">Update Billboard Size</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <form role="form" action="{{route('size.update', $size->id)}}" enctype="multipart/form-data" method="post">
            @csrf
            @method('patch')
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="size" id="exampleInputEmail1" placeholder="Enter Billboard Size Name" value="{{$size->size}}">
