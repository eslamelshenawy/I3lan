...
@section('content')
    ...
    <section class="content">
        ...
        <form role="form" action="{{route('child-location.store')}}" enctype="multipart/form-data" method="post">
            @csrf
            @method('post')
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-lg-5">
                                ...
                                <input type="text" class="form-control" name="location" id="exampleInputEmail1" placeholder="Enter Zone Name" value="{{old('location')}}">
