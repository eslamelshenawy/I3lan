...
@section('content')
    ...
    <section class="content">
        ...
        <form role="form" action="{{route('parent-location.update', $location->id)}}" enctype="multipart/form-data" method="post">
            @csrf
            @method('patch')
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="location" id="exampleInputEmail1" placeholder="Enter Area Name" value="{{$location->parentLocation_en->location}}">
