                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="name_en" id="exampleInputEmail1" placeholder="Enter Project Name" value="{{$project->project_en->name}}">
                                    <p class="help-block">Enter Project Name</p>
                                </div>

                                <div class="col-lg-6">
                                    <label for="exampleInputEmail1">Client</label>
                                    <input type="text" class="form-control" name="client" id="exampleInputEmail1" placeholder="Enter Project Client" value="{{$project->project_en->client}}">
                                    ...
                                    <select name="service_id" id="admin_type" class="form-control">
                                        ...
                                        @if($services)
                                            @foreach($services as $service)
                                                <option value="{{$service->id}}" {{$service->id == $project->service_id ? 'selected' : ''}}>{{$service->service_en->title}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    <label for="exampleInputEmail1">Project Images Display</label>
                                    <select name="display" id="admin_type" class="form-control">
                                        <option value="0">Choose Display</option>
                                        <option value="1" {{ $project->display == 1 ? 'selected' : '' }}>Grid</option>
                                        <option value="2" {{ $project->display == 2 ? 'selected' : '' }}>List</option>
                                    </select>
                                    <p class="help-block">Choose Related Images Display</p>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <textarea  class="form-control" name="description_en" id="exampleInputEmail1" placeholder="Enter Project Description" rows="6">{{$project->project_en->description}}</textarea>
