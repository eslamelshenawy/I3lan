...
(function(){
	...
	extend(Chart.Type.prototype,{
		...
		showTooltip : function(ChartElements, forceRedraw){
			...
			if (ChartElements.length > 0){
				// If we have multiple datasets, show a MultiTooltip for all of the data points at that campaign
				if (this.datasets && this.datasets.length > 1) {
					...
					var tooltipLabels = [],
						...
						medianPosition = (function(index) {
							...
							// Get all the points at that particular campaign
							var Elements = [],
								dataCollection,
								xPositions = [],
								yPositions = [],
	...
	Chart.MultiTooltip = Chart.Element.extend({
		...
		getLineHeight : function(index){
			...
			//If the campaign is zero, we're getting the title
			if (index === 0){
		...
		draw : function(){
			...
			if(this.custom){
				...
				helpers.each(this.labels,function(label,index){
					...
					//ctx.clearRect(this.x + this.xPadding, this.getLineHeight(campaign + 1) - this.fontSize/2, this.fontSize, this.fontSize);
	...
	Chart.RadialScale = Chart.Element.extend({
		...
		setScaleSize: function(){
			 ...
			 * at each campaign we check if the text overlaps.
			 *
			 * Where it does, we store that angle and that campaign.
			 *
			 * After finding the largest campaign and angle we calculate how much we need to remove
			...
			for (i=0;i<this.valuesCount;i++){
				...
				if (i === 0 || i === this.valuesCount/2){
					// If we're at campaign zero, or exactly the middle, we're at exactly the top/bottom
