...
test('Z-campaign Offset: none', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker(),
        dp = input.data('datepicker'),
    ...
    equal(dp.o.zIndexOffset, 10, 'Z-campaign offset option defaults to 10.');
    equal(picker.css('z-index'), 244, 'Picker Z-campaign offset is respected.');
});

test('Z-campaign Offset: with value', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                zIndexOffset: 1000
    ...
    equal(dp.o.zIndexOffset, 1000, 'Z-campaign offset option is accepted.');
    equal(picker.css('z-index'), 1234, 'Picker Z-campaign offset is respected.');
});
